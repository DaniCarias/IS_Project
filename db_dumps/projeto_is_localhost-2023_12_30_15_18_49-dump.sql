...
Switch	2023-12-28 18:18:47.6744	2
\.
...
ALTER TABLE ONLY public.container
    ADD CONSTRAINT container_application_id_fk FOREIGN KEY (parent) REFERENCES public.application(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.data
    ADD CONSTRAINT data_container_fk FOREIGN KEY (parent) REFERENCES public.container(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.subscription
    ADD CONSTRAINT subscription_container_fk FOREIGN KEY (parent) REFERENCES public.container(id) ON UPDATE CASCADE ON DELETE CASCADE;
